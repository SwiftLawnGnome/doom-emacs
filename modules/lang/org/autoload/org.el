...
(defvar org-hierarchical-todo-statistics)
...
(declare-function org-beginning-of-item "org-list")
...
(declare-function org-shiftmetadown "org")
(declare-function +org/table-previous-row "org-tables")
...
(declare-function org-goto-ret "org-goto")
(declare-function org-get-tags "org")
(declare-function org-force-cycle-archived "org")
(declare-function org-update-checkbox-count "org-list")
(declare-function org-update-parent-todo-statistics "org")
(declare-function org-clear-latex-preview "org")
(declare-function org--latex-preview-region "org")
(declare-function org-clock-update-time-maybe "org-clock")
(declare-function org-footnote-goto-definition "org-footnote")
(declare-function org-footnote-goto-previous-reference "org-footnote")
(declare-function org-follow-timestamp-link "org")
(declare-function org-at-TBLFM-p "org-table")
(declare-function org-table-calc-current-TBLFM "org-table")
(declare-function org-call-with-arg "org-macs")
(declare-function org-table-blank-field "org-table")
(declare-function org-table-recalculate "org-table")
(declare-function org-table-get-field "org-table")
...
(declare-function org-on-heading-p "org-compat")
(declare-function org-at-item-p "org-list")
(declare-function org-clock-in "org-clock")
(declare-function org-clock-in-last "org-clock")
(declare-function +org/toggle-fold "org")
(declare-function +org/close-fold "org")
...
(declare-function org-outdent-item-tree "org-list")
(declare-function org-indent-item-tree "org-list")
(declare-function org-at-heading-p "org")
(declare-function org-promote "org")
(declare-function org-demote "org")
(declare-function org-in-src-block-p "org")
(declare-function org-babel-do-in-edit-buffer "ob-core")
(declare-function org-in-subtree-not-table-p "org")
...
(declare-function org-superstar-restart "org-superstar")
(declare-function org-beginning-of-line "org")
(declare-function org-cycle-internal-local "org")
(declare-function org-babel-where-is-src-block-result "ob-core")
(declare-function org-babel-remove-result "ob-core")
...
(defun +org--toggle-inline-images-in-subtree (&optional beg end refresh)
  ...
  (let ((beg (or beg
        ...
        (overlays (doom-keep (lambda (ov) (overlay-get ov 'org-image-overlay))
...
(defun +org-get-todo-keywords-for (&optional keyword)
  ...
  (when keyword
    (cl-loop
       for (type . keyword-spec) in
        (doom-keep #'listp org-todo-keywords)
       for keywords =
        (mapcar (lambda (x)
                  (if (string-match "^\\([^(]+\\)(" x)
                      (match-string 1 x)
